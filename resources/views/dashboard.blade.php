                ...
                <div class="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900 mt-1">{{ $totalKaryawan }} <span class="text-lg font-normal text-gray-500">Orang</span></h3>
                        </div>
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900 mt-1">{{ $totalLaki }} <span class="text-lg font-normal text-gray-500">Orang</span></h3>
                        </div>
                ...
                <div class="bg-pink-50 border-l-4 border-pink-500 p-6 rounded-r-lg shadow-sm">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900 mt-1">{{ $totalPerempuan }} <span class="text-lg font-normal text-gray-500">Orang</span></h3>
                        </div>
